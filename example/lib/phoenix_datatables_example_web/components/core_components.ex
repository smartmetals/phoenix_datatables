defmodule PhoenixDatatablesExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixDatatablesExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixDatatablesExampleWeb.Gettext, "errors", msg, opts)
    end
  end
