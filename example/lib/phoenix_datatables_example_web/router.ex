defmodule PhoenixDatatablesExampleWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {PhoenixDatatablesExampleWeb.Layouts, :root}
  ...
  if Application.compile_env(:phoenix_datatables_example, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PhoenixDatatablesExampleWeb.Telemetry
